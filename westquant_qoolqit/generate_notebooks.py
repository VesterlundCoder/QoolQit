...
combined_cells = [
    ...
    md(["## 5. Key Finding\n",
        ...
        "shows that the **H×R interaction** is the dominant effect (median η² = 47.7%),\n",
        ...
        "| H (Hamiltonian) | 7.2% |\n",
        "| R (Embedding) | 33.1% |\n",
        "| H×R (Interaction) | 47.7% |\n",
        "| Residual | ~2% |\n",
        "\n",
        "Search improves over baseline in 100% of problems (median improvement: 65.9%).\n",
