...
combined_cells = [
    ...
    code(["combined = combined_search(\n",
          ...
          "print(f'\\nVariance from Hamiltonian (H): {vd[\"frac_H\"]:.1%}')\n",
          "print(f'Variance from Embedding  (R): {vd[\"frac_R\"]:.1%}')"]),
    ...
    md(["## 5. Key Finding\n",
        "\n",
        "Both the Hamiltonian representation choice and the embedding choice\n",
        "contribute meaningfully to final solution quality, validating the thesis\n",
        "that representation itself can be treated as an optimization variable.\n",
